...
class TradeBot():
    ...
    def train(self):
        env = Environment1(self.train_data)
        ...
        ########################################
        torch.save(Q.state_dict(), 'lstm6_model_params')
    ...
    def test(self):
        ...
        test_env = Environment1(self.test_data)
        
        # Load saved model
        Q = Q_Network(INPUT_SIZE, HIDDEN_SIZE, OUTPUT_SIZE)

        Q.load_state_dict(torch.load('lstm6_model_params'))
